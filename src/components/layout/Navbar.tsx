...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-0 border border-white/18 rounded-full bg-black/60 backdrop-blur-md px-2 py-1.5 pointer-events-auto" style={{ isolation: "isolate" }}>
        {/* Logo shield mark */}
